...
func resolveLauncher() string {
	if envBrowser := os.Getenv("01CLOUD_BROWSER"); envBrowser != "" {
		return envBrowser
	}
	// NOTE: THIS PORTION IS COMMENTED, AS IT WILL BE IMPLEMENTED ON NEAR FUTURE
	//
	//cfg, err := config.Read()
	//if err == nil {
